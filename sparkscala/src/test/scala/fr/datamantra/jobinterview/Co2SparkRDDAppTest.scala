...
class Co2SparkRDDAppTest extends FunSuite with BeforeAndAfter with Matchers {
  ...
  test("runAppShouldCorrectlyComputeTheTopTenEmittersForLastTenYears") {
    // Test
    val results: Results = Co2SparkRDDApp.runApp(sparkSession, "src/test/resources/co2_emissions_tonnes_per_person.csv")
